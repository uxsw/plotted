            ...
            >
              <span
                className={[
                  ...
                  isToday ? "text-ink font-semibold" : "text-ink-soft font-medium",
                ].join(" ")}
              >
                {formatDay(date, i)}
              </span>
              <WeatherIcon code={daily.weather_code[i]} size={20} />
              <span className="font-sans text-sm font-medium leading-none text-ink">
                {Math.round(daily.temperature_2m_max[i])}°
              </span>
              <span className="font-sans text-xs leading-none text-ink-soft">
