...
Arrivals — a fresh suggestion panel's cards in the chat, and cards and silhouettes on the sheet — run "the planting" (see Motion). This is the workspace's one authored moment; the elevation and year strip themselves are still surfaces that react, never perform.
