...
| `.o-badge` | object | `styles/objects/badge/_badge.scss` | built, colours provisional, migration pending | `styles/objects/badge.design.md` |
| `.o-roundel` | object | `styles/objects/roundel/_roundel.scss` | built, colours provisional, migration pending | `styles/objects/roundel.design.md` |
